/***********************************************************************//**
 * @file		lpc43xx_clkpwr.h
 * @brief		Contains all macro definitions and function prototypes
 * 				support for Clock and Power Control firmware library on lpc43xx
 * @version		1.0
 * @date		14. Dec. 2010
...
#ifndef lpc43xx_CLKPWR_H_
#define lpc43xx_CLKPWR_H_
...
typedef enum {
	...
	CLKPWR_CLKSRC_PLL0_USB,
	CLKPWR_CLKSRC_PLL0_AUDIO,
	CLKPWR_CLKSRC_PLL1,
